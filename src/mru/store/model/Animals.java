...
public class Animals extends Toy{
	...
	public Animals(int serialNumber, String toyName, String toyBrand, double toyPrice, int availableCount, int appropriateAge, String animalMaterial, String animalSize) {
